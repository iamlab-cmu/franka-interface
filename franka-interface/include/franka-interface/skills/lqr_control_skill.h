#ifndef FRANKA_INTERFACE_SKILLS_LQR_CONTROL_SKILL_H_
#define FRANKA_INTERFACE_SKILLS_LQR_CONTROL_SKILL_H_

#include "franka-interface/skills/base_skill.h"

class LqrControlSkill : public BaseSkill {
 public:
  LqrControlSkill(int skill_idx, int meta_skill_idx, std::string description) : 
...
#endif  // FRANKA_INTERFACE_SKILLS_LQR_CONTROL_SKILL_H_